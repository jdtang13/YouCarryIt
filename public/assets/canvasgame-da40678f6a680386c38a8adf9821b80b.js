...
function Cell (worldX,worldY) 
{
    ...
    this.update = function(dt)
    {
        ...
        for (var i = 0; i < this.cellWallX.length; i++) 
        {
        	...
        	var undulationX = Math.cos(this.undulationAngle + (atEveryRadians*i)) * undulationAmplitude;
        	var undulationY = Math.sin(this.undulationAngle + (atEveryRadians*i)) * undulationAmplitude;
            ...
            this.cellWallY[i] = worldY + ys + undulationY;
        };
    };

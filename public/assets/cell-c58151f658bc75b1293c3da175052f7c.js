...
function Cell (worldX,worldY) 
{
    ...
    this.expendResources = function() {
        ...
        document.getElementById("Nutrient Information").innerHTML = 
            ("Energy: " + this.nutrientLevels.energyLevel + " " + "Protein: " + this.nutrientLevels.proteinLevel 
            + " " + "Water: " + this.nutrientLevels.waterLevel);
    };

    this.addNutrient = function(nutrient) {
        if (nutrient.feature === "energy") {
            this.nutrientLevels.energyLevel +=  nutrient.nutritiousFactor * DEFAULT_NUTRITION_BOOST;
        };      

        if (nutrient.feature === "protein") {
            this.nutrientLevels.proteinLevel +=  nutrient.nutritiousFactor * DEFAULT_NUTRITION_BOOST;        }

        if (nutrient.feature === "water") {
            this.nutrientLevels.waterLevel += nutrient.nutriousFactor * DEFAULT_NUTRITION_BOOST;
        }
